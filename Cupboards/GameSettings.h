...
public:
	...
	const std::vector<VectorInt>& GetLocCoordVector() const { return gamedata.locations_coordinates; }
	const std::vector<uint32_t>& GetStartLocations() const { return gamedata.chips_start_location; }
	const std::vector<uint32_t>& GetWinLocations() const { return gamedata.chips_win_location; }
	const std::vector<sf::Vector2f>& GetVerticalWiresVector() const { return gamedata.vertical_wires_coordinates; }
	const std::vector<sf::Vector2f>& GetHorisontalWiresVector() const { return gamedata.horisontal_wires_coordinates; }
